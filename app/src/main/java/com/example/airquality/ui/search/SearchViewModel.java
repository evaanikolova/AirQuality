...
//                Snackbar.make(searchButton, t.getMessage(), Snackbar.LENGTH_SHORT).show();
    ...
    public void saveFavouriteCity(Context c, String city) {
        sharedPreferences = c.getSharedPreferences(spFile, Context.MODE_PRIVATE);

        SharedPreferences.Editor preferencesEditor = sharedPreferences.edit();
        preferencesEditor.putString("favouriteCity", city);
        preferencesEditor.apply();

        Log.i("saveFauriteCity", "zapisahme lubimiq grad");
    }
